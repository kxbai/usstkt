...
static void itemLoader(byte num)
{
  ...
  setMenuOption_P(num++, PSTR(Pulse_NAME), NULL, mpu_open);	
...
//	setMenuOption_P(num++, buff, NULL, LogTimeUpdate);
  ...
  setMenuOption_P(num++, PSTR(CMD4_NAME), NULL, Pulse_send);
}
...
bool my_menu_open(void)
{
	...
	buttons_setFuncs(menu_down,menu_select,menu_up);  //绑定按键功能函数
