...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_11)//SCL=0
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_11)//SCL=1

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_10)//SDA=0
#define OLED_SDIN_Set() GPIO_SetBits(GPIOB,GPIO_Pin_10)//SDA=1
