...
//#define KEY0        GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_10)  //right
//#define KEY1        GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_5) //ok
//#define KEY2        GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14)//left

#define KEY0        GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)  //right
#define KEY1        GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_1) //ok
#define KEY2        GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)//left
